...
class DicEntry(Frame):
    ...
    The edit functions including create/delete/edit/import/export dictionaries.
    '''
    ...
    def onCreate(self):
        '''
        set up for the new dictionary pass to edit
        '''
    ...
    def onEdit(self):
        '''
        pass current selected dictionary to main controller to go to dicEdit
        '''
